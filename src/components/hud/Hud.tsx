...
function Hud() {
  ...
  // useEffect(() => {
  //   setTimeout(() => {
  //     setHeightAgl(Math.floor(Math.random() * (10 - -10 + 1)) + -10);
  //   }, 2000);
  // }, [heightAgl]);
  ...
  return (
    <div className="hub-container">
      ...
      <div className="hub-container__center">
        <div className="hub-container__center-content">
          <img className="img2" src={img2} alt="img2" />
          <img className="img3" src={img3} alt="img3" />
          <img className="img4" src={img4} alt="img4" />
          <img
            style={{
              transform: `skew(0deg,${heightAgl}deg) translate(-50%, -50%) `,
              top: `calc(50% + ${heightAgl / 2}%)`,
            }}
            className="img5"
            src={img5}
            alt="img5"
          ...
          <div
            ...
            className="hub-container__center-content-rotate-1"
          >
            <img
              style={{
                transform:
          ...
          <div
            ...
            className="hub-container__center-content-rotate-2"
          >
            <img
              style={{
                transform:
          ...
          <div className="speed-indicator">
            <div className="scroll-speed-indicator">
              <div
                style={{
                  top: `${heightAgl * 3.5}px`,
                }}
                className="scrollbar-speed-indicator"
              >
                {directionIndicators1.map((item, index) => {
                  return (
                    <div className="scroll-direction-item" key={index}>
                      <span className="item-number-left">{item}</span>
                      <img src={img8} className="img8" alt="img8" />
                      <span className="item-number-right">{item}</span>
                    </div>
                  );
                })}
                {directionIndicators2.map((item, index) => {
                  return (
                    <div className="scroll-direction-item" key={index}>
                      <span className="item-number-left">{item}</span>
                      <img src={img9} className="img9" alt="img9" />
                      <span className="item-number-right">{item}</span>
                    </div>
                  );
                })}
          ...
          <ul className="speed-list">
            <li>
              <p>Height (AGL)</p>
              <p>{`${height.heightAgl.toFixed(2)}`}</p>
            </li>
            <li>
              <p>Height (MSL)</p>
          ...
          <div className="hub-container__center-direction">
            <img
